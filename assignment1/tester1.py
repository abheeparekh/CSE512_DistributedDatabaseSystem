...
if __name__ == '__main__':
    try:
        ...
        with testHelper.getOpenConnection(dbname=DATABASE_NAME) as conn:
            ...
            [result, e] = testHelper.testrangeinsert(MyAssignment, RATINGS_TABLE, 100, 2, 1, conn, '0')
            ...
            [result, e] = testHelper.testroundrobininsert(MyAssignment, RATINGS_TABLE, 200, 1, 3, conn, '1')
